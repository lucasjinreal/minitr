...
from .configs.config_condinst import add_condinst_config
...
def add_yolo_config(cfg):
    ...
    _C.MODEL.YOLO.KEYPOINTS_NUM = 17 # coco num
    ...
    _C.MODEL.YOLO.AUX_DETACH_ITER = 10000
    _C.MODEL.YOLO.USE_AUX_HEAD = False

    _C.MODEL.YOLO.IOU_TYPE = "ciou"  # diou or iou
    _C.MODEL.YOLO.LOSS_TYPE = "v4"
    _C.MODEL.YOLO.KEYPOINTS_SIGMAS = []
    ...
    _C.MODEL.YOLO.NECK.OUT_CHANNELS = 96  #
    _C.MODEL.YOLO.NECK.NUM_EXTRA_LEVEL = 1  
    _C.MODEL.YOLO.NECK.ACTIVATION = "LeakyReLU"

    _C.MODEL.YOLO.HEAD = CN()
    _C.MODEL.YOLO.HEAD.TYPE = "yolox"
    _C.MODEL.YOLO.HEAD.ACTIVATION = "LeakyReLU"
