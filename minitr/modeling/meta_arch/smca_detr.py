...
from yolov7.utils.boxes import (
    box_cxcywh_to_xyxy,
    box_xyxy_to_cxcywh,
    convert_coco_poly_to_mask,
    generalized_box_iou,
)
from yolov7.utils.misc import (
    NestedTensor,
...
from .detr_seg import (
    DETRsegm,
    PostProcessPanoptic,
    PostProcessSegm,
    sigmoid_focal_loss_with_mode,
    dice_loss,
)
    ...
    def forward(self, images):
        ...
        if self.onnx_export:
            ...
            for i, k in enumerate(self.return_interm_layers):
                out_nested_features[k] = NestedTensor(features_returned[k], masks[i])
...
class SetCriterion(nn.Module):
    ...
    def loss_labels(self, outputs, targets, indices, num_boxes, log=True):
        ...
        if log:
            ...
            losses["class_error"] = (
                100 - accuracy(src_logits_orig[idx], target_classes_o)[0]
            )
        return losses
    ...
    def loss_masks(self, outputs, targets, indices, num_boxes):
        ...
        losses = {
            "loss_mask": sigmoid_focal_loss_with_mode(
