...
from yolov7.utils.misc import NestedTensor, interpolate, nested_tensor_from_tensor_list
...
def sigmoid_focal_loss_with_mode(
    inputs, targets, num_boxes, alpha: float = 0.25, gamma: float = 2, mode="mask"
):
    """
    Loss used in RetinaNet for dense detection: https://arxiv.org/abs/1708.02002.
    Args:
