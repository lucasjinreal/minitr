...
from ..backbone.layers.conv import ConvModule, DepthwiseConvModule
...
class RepGhostPAN(nn.Module):
    """Path Aggregation Network with Ghost block.
    Using Rep to boost mAP while still remain less flops when deploy
    ...
    def __init__(
        ...
        super(RepGhostPAN, self).__init__()
        ...
        for idx in range(len(in_channels) - 1):
            ...
            # TODO: here replace GhostBlock with RepBlock
