...
class Res2Net(Backbone):
    def __init__(
        self, block, layers, baseWidth=26, scale=4, num_classes=None, out_features=None
    ):
        self.inplanes = 64
...
def res2net101_v1b(pretrained=False, **kwargs):
    ...
    if pretrained:
        model.load_state_dict(
            model_zoo.load_url(model_urls["res2net101_v1b_26w_4s"]), strict=False
        )
    return model
...
def res2net152_v1b_26w_4s(pretrained=False, **kwargs):
    ...
    if pretrained:
        model.load_state_dict(
            model_zoo.load_url(model_urls["res2net152_v1b_26w_4s"]), strict=False
        )
    return model
